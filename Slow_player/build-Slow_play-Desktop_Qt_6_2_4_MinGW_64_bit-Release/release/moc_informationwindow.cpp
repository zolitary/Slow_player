...
#include <memory>
#include "../../Slow_play/informationwindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_informationWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_informationWindow_t qt_meta_stringdata_informationWindow = {
    {
QT_MOC_LITERAL(0, 17) // "informationWindow"
...
const QMetaObject informationWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_informationWindow.offsetsAndSize,
    qt_meta_data_informationWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_informationWindow_t
, QtPrivate::TypeAndForceComplete<informationWindow, std::true_type>
