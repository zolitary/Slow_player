...
#include <memory>
#include "../../Slow_play/videoplayer.h"
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1]))); break;
        case 1: _t->timeChanged((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1]))); break;
        case 2: _t->initFinished((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1]))); break;
        case 3: _t->playFailed((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1]))); break;
        case 4: _t->frameDecoded((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint8_t*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<VideoSwsSpec&>>(_a[3]))); break;
        default: ;
        }
