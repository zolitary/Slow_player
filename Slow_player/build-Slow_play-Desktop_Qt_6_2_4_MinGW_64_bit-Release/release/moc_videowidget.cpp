...
#include <memory>
#include "../../Slow_play/videowidget.h"
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onPlayerFrameDecoded((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint8_t*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<VideoPlayer::VideoSwsSpec&>>(_a[3]))); break;
        case 1: _t->onPlayerStateChanged((*reinterpret_cast< std::add_pointer_t<VideoPlayer*>>(_a[1]))); break;
        default: ;
        }
